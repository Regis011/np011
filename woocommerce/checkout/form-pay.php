	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'np011' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'np011' ); ?></th>
			</tr>
		</thead>
		<tbody>
